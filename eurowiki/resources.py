...
PREDICATE_LABELS =  OrderedDict([
    ...
    ('PUE18', {'en': 'method of communication', 'it': 'modalità di esternazione',}), # brand-NEW for some symbols
...
LITERAL_PROPERTIES = ['label', 'PUE1', 'PUE2', 'P41', 'P94', 'P1541', 'P1476', 'P18', 'P828', 'P571', 'P577', 'P580', 'P582', 'P837', 'P948', 'P953', 'P854', 'PUE4', 'PUE5', 'PUE7', 'PUE8', 'PUE9', 'PUE11', 'PUE12', 'PUE13', 'PUE14', 'PUE15', 'PUE16', 'PUE17', 'PUE18', 'comment', 'P248',] # properties occurring in Literal Statements
RDF_I18N_PROPERTIES = ['label', 'PUE1', 'PUE2', 'P1541', 'P1476', 'P828', 'P837', 'PUE4', 'PUE5', 'PUE7', 'PUE8', 'PUE9', 'PUE11', 'PUE12', 'PUE13', 'PUE14', 'PUE15', 'PUE16', 'PUE17', 'PUE18', 'comment',] # RDF properties having a literal value language-awware
